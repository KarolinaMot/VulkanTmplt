...
void Vulkan::CreateColorResources()
{
    ...
    colorImage = new Image(this, swapChainExtent.width, swapChainExtent.height, colorFormat, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSIENT_ATTACHMENT_BIT | VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, 1, msaaSamples);
    colorImageView = Image::CreateImageView(this, colorImage->GetImage(), colorFormat, VK_IMAGE_ASPECT_COLOR_BIT, 1);
}
...
void Vulkan::CreateDepthResources()
{
    ...
    depthImage = new Image(this, swapChainExtent.width, swapChainExtent.height, depthFormat, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, 1, msaaSamples);
