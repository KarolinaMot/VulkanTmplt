...
VBO::VBO(const Vulkan& vulkan, const std::vector<Vertex>& vertices, const std::vector<uint16_t>& indices)
{
...
void VBO::CreateVertexBuffer(const Vulkan& vulkan, const std::vector<Vertex>& vertices)
{
...
void VBO::CreateIndexBuffer(const Vulkan& vulkan, const std::vector<uint16_t>& indices)
{
